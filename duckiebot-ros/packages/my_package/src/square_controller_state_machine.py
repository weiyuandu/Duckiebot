...
"""
Square Controller with State Machine and Encoder-based Odometry
Based on encoder_pos_node.py structure with precise localization
"""

from duckietown.dtros import DTROS, NodeType, TopicType
from duckietown_msgs.msg import (
    Pose2DStamped, Twist2DStamped, WheelEncoderStamped, LEDPattern
)
...
class SquareControllerStateMachine(DTROS):
    """
    Square controller using state machine with encoder-based odometry
    ...
    def __init__(self, node_name):
        ...
        super(SquareControllerStateMachine, self).__init__(
        ...
        if not self.veh:
            self.veh = os.environ.get('VEHICLE_NAME', 'duck')
        ...
        # Wait until the encoders data is received
...
if __name__ == "__main__":
    node = SquareControllerStateMachine(node_name="square_controller_state_machine")
    rospy.spin()
